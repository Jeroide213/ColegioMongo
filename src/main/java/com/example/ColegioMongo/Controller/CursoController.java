...
public class CursoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Curso> obtenerPorId(@PathVariable("id") ObjectId id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Curso> actualizar(@PathVariable("id") ObjectId id, @RequestBody Curso nuevoCurso) {

...
public class CursoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Curso> obtenerPorId(@PathVariable("id") Long id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Curso> actualizar(@PathVariable("id") Long id, @RequestBody Curso nuevoCurso) {
